  ...
  const handleSubmit = async (event: FormEvent<HTMLFormElement>) => {
    ...
    try {
      await onSubmit({
        ...
        prazoEstimadoDias: form.prazoEstimadoDias
          ? Number(form.prazoEstimadoDias)
          : null,
      });
      toast({
        title:
          mode === "edit"
            ? t("budgets.toasts.updateTitle", {
                defaultValue: "Orçamento atualizado",
              })
            : t("budgets.title"),
        description:
          mode === "edit"
            ? t("budgets.toasts.updateDescription", {
                defaultValue: "Alterações salvas com sucesso.",
              })
            : t("budgets.subtitle"),
      });
      closeAndReset();
      ...
      toast({
        title:
          mode === "edit"
            ? t("budgets.toasts.updateError", {
                defaultValue: "Não foi possível salvar o orçamento",
              })
  ...
  return (
    ...
    >
      ...
      <DialogContent className="max-w-lg">
        <DialogHeader>
          <DialogTitle>
            {mode === "edit" ? t("common.actions.edit") : t(triggerLabel)}
          </DialogTitle>
        </DialogHeader>
        <form className="space-y-4" onSubmit={handleSubmit}>
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <div className="space-y-2">
              ...
              <Select
                value={form.carId}
                onValueChange={(value) =>
                  setForm((current) => ({ ...current, carId: value }))
                }
                required
          ...
          <div className="space-y-2">
            <Label htmlFor="prazoEstimadoDias">
            ...
            <Input
              ...
              onChange={(event) =>
                setForm((current) => ({
                  ...current,
                  prazoEstimadoDias: event.target.value,
                }))
              }
            />
